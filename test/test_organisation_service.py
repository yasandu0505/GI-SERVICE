...
async def test_enrich_department_item(organisation_service, mock_opengin_service):
    ...
    mock_opengin_service.fetch_relation.return_value = [ Relation(id="", relatedEntityId="department_123", name=RelationNameEnum.AS_CATEGORY, startTime="2020-08-09T00:00:00Z", endTime="2022-03-08T00:00:00Z", direction=RelationDirectionEnum.OUTGOING)]
...
async def test_departments_by_portfolio_id_success(organisation_service, mock_opengin_service):
    ...
    mock_opengin_service.fetch_relation.return_value = [ Relation(id="", relatedEntityId="portfolio_123", name= RelationNameEnum.AS_DEPARTMENT, startTime="2020-08-09T00:00:00Z", endTime="2022-03-08T00:00:00Z", direction=RelationDirectionEnum.OUTGOING)]
    ...
    mock_opengin_service.fetch_relation.assert_called_once_with(
        ...
        relation=Relation(name=RelationNameEnum.AS_DEPARTMENT, activeAt=f'{selected_date}T00:00:00Z', direction=RelationDirectionEnum.OUTGOING)
    )
...
async def test_prime_minister_success(organisation_service, mock_opengin_service):
    ...
    mock_response = Relation(name=RelationNameEnum.AS_PRIME_MINISTER, activeAt='', relatedEntityId='cit_3', startTime='2022-07-26T00:00:00Z', endTime='2024-09-23T00:00:00Z', id='person_123', direction=RelationDirectionEnum.OUTGOING)
    ...
    mock_opengin_service.fetch_relation.assert_called_once_with(
        entityId='gov_01',
        relation=Relation(name=RelationNameEnum.AS_PRIME_MINISTER, activeAt=Util.normalize_timestamp(selected_date), direction=RelationDirectionEnum.OUTGOING)
    )
